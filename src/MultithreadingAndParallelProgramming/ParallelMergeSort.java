...
public class ParallelMergeSort {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < list1.length; i++) {
            list1[i] = list2[i] = (int)(Math.random()*1000000000);
        ...
        System.out.println("Squentiel time is with processors :"  + Runtime.getRuntime().availableProcessors() +"pcs"+ (endTime - startTime) + "milliseconds");
